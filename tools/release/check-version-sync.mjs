...
export function checkVersionSync(root){
  ...
  const rEnvironment=json(root,"tools/interop/r-environment.json");if(rEnvironment.rVersion!=="4.4.3"||rEnvironment.transitivePackages?.Deriv!=="4.2.0"||rEnvironment.packages?.ChainLadder!=="0.2.21"||rEnvironment.packages?.jsonlite!=="2.0.0")errors.push("R environment must be 4.4.3 / Deriv 4.2.0 / ChainLadder 0.2.21 / jsonlite 2.0.0");
