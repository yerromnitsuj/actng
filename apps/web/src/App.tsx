...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* pb-32: the last panels must scroll well clear of OS chrome (an
          overlaying macOS dock runs ~90-120px) - a page that ends flush at
          the viewport edge reads as cut off on any machine with a bottom
          overlay. */}
      <main className="mx-auto w-full max-w-[1720px] flex-1 px-6 pt-6 pb-32">
        <Routes>
